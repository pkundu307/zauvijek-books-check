        ...
        <Stack direction={'row'} align={'center'} spacing={4}>
          ...
          <ButtonGroup size="sm" isAttached variant={'outline'}>
            <Link to={'/sale-invoice/new'}>
              <Button leftIcon={<RiAddLine />} color={modeBrand} size={'sm'} rounded={0}>
            ...
            <Menu>
              <MenuButton
                ...
                aria-label="Create Vouchers"
              />
              <MenuList pt="1rem" boxShadow="lg" fontSize="sm" rounded={0}>
                <Link to="/sale-return/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+z">
                    Sales Return
                  </MenuItem>
                </Link>
                <Link to="/quotation/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+w">
                    Quotation
                  </MenuItem>
                </Link>
                <Link to="/proforma-invoice/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+s">
                    Proforma Invoice
                  </MenuItem>
                </Link>
                <Link to="/delivery-challan/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+x">
                    Delivery Challan
                  </MenuItem>
                </Link>
                <Link to="/credit-note/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+e">
                    Credit Notes
                  </MenuItem>
                </Link>
                <MenuDivider />
                <Link to="/purchase-invoice/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+c">
                    Purchase Invoice
                  </MenuItem>
                </Link>
                <Link to="/purchase-return/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+l">
                    Purchase Returns
                  </MenuItem>
                </Link>
                <Link to="/debit-note/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command={'alt+o'}>
                    Debit Note
                  </MenuItem>
                </Link>
                <Link to="/purchase-order/new">
                  <MenuItem icon={<RiAddLine size="18px" />} command="alt+k">
                    Purchase Order
                  </MenuItem>
                </Link>
              </MenuList>
