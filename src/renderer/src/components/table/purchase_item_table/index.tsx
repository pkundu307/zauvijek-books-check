...
//   const { fields, append, remove } = props.purchaseItem
...
//                       <Controller
//                         control={control}
//                         name={`purchase_item.${index}.item_name`}
//                         render={({ field: { value, onChange } }) => (
//                           <DownshiftSearchItem
...
//                     <Controller
//                       control={control}
//                       name={`purchase_item.${index}.item_description`}
...
//                   <Controller
//                     control={control}
//                     name={`purchase_item.${index}.hsn_code`}
//                     render={({ field: { value, onChange, onBlur } }) => (
//                       <Input
//                         value={value}
//                         onChange={onChange}
...
//                   <Controller
//                     control={control}
//                     name={`purchase_item.${index}.quantity`}
//                     render={({ field: { value, onChange } }) => (
...
//                   <Controller
//                     control={control}
//                     name={`purchase_item.${index}.price`}
//                     render={({ field: { value, onChange, onBlur } }) => (
//                       <InputGroup size="xs">
...
//                     <Controller
//                       control={control}
//                       name={`purchase_item.${index}.discount_value`}
//                       render={({ field: { value, onChange, onBlur } }) => (
//                         <InputGroup size="xs">
//                           <InputLeftAddon children={'₹'} />
//                           <Input
...
//                     <Controller
//                       control={control}
//                       name={`purchase_item.${index}.discount_rate`}
//                       render={({ field: { value, onChange, onBlur } }) => (
//                         <InputGroup size="xs">
//                           <Input
//                             type="number"
...
//                   <Controller
//                     control={control}
//                     name={`purchase_item.${index}.taxable_amount`}
//                     render={({ field: { value, onChange, onBlur } }) => (
//                       <InputGroup size="xs">
//                         <InputLeftAddon children={'₹'} />
//                         <Input
...
//                     <Controller
//                       control={control}
//                       name={`purchase_item.${index}.tax_value`}
//                       render={({ field: { value, onChange, onBlur } }) => (
//                         <InputGroup size="xs">
//                           <InputLeftAddon children={'₹'} />
//                           <Input
...
//                   <Controller
//                     control={control}
//                     name={`purchase_item.${index}.amount`}
//                     render={({ field: { value, onChange, onBlur } }) => (
//                       <InputGroup size="xs">
//                         <InputLeftAddon children={'₹'} />
//                         <Input
...
//               </Thead>
//               <Tbody>
//                 {watchFields?.taxes?.map((tax: any, index: number) => (
//                   <Tr key={index}>
...
//                     <Controller
//                       control={control}
//                       name={`purchase_additional_charge.${index}.name`}
//                       render={({ field: { value, onChange, onBlur } }) => (
//                         <Input
//                           type="text"
//                           value={value}
...
//                     <Controller
//                       control={control}
//                       name={`purchase_additional_charge.${index}.amount`}
//                       render={({ field: { value, onChange, onBlur } }) => (
//                         <InputGroup size={'sm'}>
//                           <InputLeftAddon children={'₹'} />
...
//                       <Controller
//                         name={`purchase_payment_mode.${index}.account_name`}
//                         control={control}
//                         render={({ field: { value, onChange } }) => {
//                           return (
//                             <DownshiftSelectString
...
//                         <Controller
//                           name={`purchase_payment_mode.${index}.amount`}
//                           control={control}
//                           render={({ field: { value, onChange, onBlur } }) => {
//                             return (
//                               <InputGroup size="sm">
...
//                       <FormControl w="45%">
//                         <Controller
//                           name={`purchase_payment_mode.${index}.payment_type`}
//                           control={control}
//                           render={({ field: { value, onChange } }) => {
//                             return (
//                               <DownshiftSelectString
              ...
              <Tr key={index}>
                ...
                >
                  <Stack spacing={1}>
                    <Controller
                      control={control}
                      name={`purchase_item.${index}.discount_amount`}
                      render={({ field: { value, onChange, onBlur } }) => (
                        <InputGroup size="xs">
                          <InputLeftAddon children={'₹'} />
                          <Input
                    ...
                    <Controller
                      control={control}
                      name={`purchase_item.${index}.discount_percent`}
                      render={({ field: { value, onChange, onBlur } }) => (
                        <InputGroup size="xs">
                          <Input
                            type="number"
                ...
                >
                  <Stack spacing={1}>
                    ...
                    <Controller
                      control={control}
                      name={`purchase_item.${index}.tax_amount`}
                      render={({ field: { value, onChange, onBlur } }) => (
                        <InputGroup size="xs">
                          <InputLeftAddon children={'₹'} />
                          <Input
        ...
        <Stack direction="row" spacing={0} borderTop="1px solid" borderColor={mode30}>
          <Stack w="50%" minH="300px" borderRight="1px solid" borderColor={mode30}>
            <Table size="sm">
              ...
              <Tbody>
                {watchFields?.purchase_tax?.map((tax: any, index: number) => (
                  <Tr key={index}>
                    {/* <Td p={1} border="1px" fontSize="xs" borderColor={mode30}>
                      {index + 1}
                    </Td> */}
                ...
                {props?.paymentMode?.fields?.map((_field: any, index: number) => (
                  <Stack key={index} direction="row" spacing={6} alignItems="flex-end">
                    ...
                    <Stack w="50%" direction="row" spacing={0} alignItems="flex-end">
                      ...
                      <FormControl w="45%">
                        <Controller
                          name={`purchase_payment_mode.${index}.payment_mode`}
                          control={control}
                          render={({ field: { value, onChange } }) => {
                            return (
                              <DownshiftSelectString
