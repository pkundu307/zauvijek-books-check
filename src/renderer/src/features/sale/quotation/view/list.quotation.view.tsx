...
export default function ListQuotationView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  CUSTOM HOOKS START
   *
  ...
  const columns = [
    ...
    },
    {
      ...
      accessorKey: 'id',
      cell: (row: any) => (
        <RowOptions type={'quotation'} row={{ id: row.getValue() }} onDelete={props.handleDelete} />
      )
    }
  ]
      ...
      <Flex py={4} px={0} justify={'space-between'} align="center">
        <Stack direction={'row'} align={'center'} spacing={2}>
          ...
          <Breadcrumb separator={<RiArrowRightSLine />}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink isCurrentPage>Quotation</BreadcrumbLink>
            </BreadcrumbItem>
          </Breadcrumb>
        </Stack>
