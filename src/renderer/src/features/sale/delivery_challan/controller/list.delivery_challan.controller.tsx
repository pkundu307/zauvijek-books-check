import ListDeliveryChallanView from '../view/list.delivery_challan.view'
import { useEffect, useMemo, useState } from 'react'
import { PaginationState } from '@tanstack/react-table'
import { searchByProperty } from '@renderer/utils/serach_by_propertyname'

const ListDeliveryChallanController = (props: any) => {
  /**
   * ----------------------------------------------------------------------
   *  LOCAL STATES START
   *
...
export default ListDeliveryChallanController
