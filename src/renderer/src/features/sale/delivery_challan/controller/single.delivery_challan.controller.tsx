...
import SingleDeliveryChallanView from '../view/single.delivery_challan.view'

const SingleDeliveryChallanController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SingleDeliveryChallanController
