...
import SingleDeliveryChallanController from '../controller/single.delivery_challan.controller'

export default function SingleDeliveryChallanModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return (
    <SingleDeliveryChallanController
      id={id}
      activeTab={activeTab}
