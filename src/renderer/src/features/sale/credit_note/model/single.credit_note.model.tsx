...
import SingleCreditNoteController from '../controller/single.credit_note.controller'

export default function SingleCreditNoteModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
