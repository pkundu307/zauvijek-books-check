...
import SingleCreditNoteView from '../view/single.credit_note.view'

const SingleCreditNoteController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SingleCreditNoteController
