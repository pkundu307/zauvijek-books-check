...
export default function FormCreditNoteView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
      ...
      <Flex p={4} justify="space-between" align="center">
        <Stack direction="row" align="center" spacing={2}>
          ...
          <Breadcrumb separator={<RiArrowRightSLine />}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} to="/sale-return">
                Credit Notes
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
        ...
        <GridItem colSpan={1}>
          ...
          >
            <Stack p={4} spacing={6}>
              <Stack direction="row" spacing={4}>
                <FormControl>
                  <FormLabel fontSize="sm">Credit Note Prefix</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_prefix"
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Credit Note No.</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_no"
                    render={({ field: { value, onChange, onBlur } }) => (
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Credit Note Date</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_date"
                    render={({ field: { value, onChange } }) => (
