...
import ListProformaInvoiceView from '../view/list.proforma_invoice.view'

const ListProformaInvoiceController = (props: any) => {
  /**
   * ----------------------------------------------------------------------
   *  LOCAL STATES START
   *
...
export default ListProformaInvoiceController
