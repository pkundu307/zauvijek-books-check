...
import SingleProformaInvoiceView from '../view/single.proforma_invoice.view'

const SingleProformaInvoiceController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SingleProformaInvoiceController
