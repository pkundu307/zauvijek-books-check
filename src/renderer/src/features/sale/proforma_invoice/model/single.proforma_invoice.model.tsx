...
import SingleProformaInvoiceController from '../controller/single.proforma_invoice.controller'

export default function SingleProformaInvoiceModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return (
    <SingleProformaInvoiceController
      id={id}
      activeTab={activeTab}
