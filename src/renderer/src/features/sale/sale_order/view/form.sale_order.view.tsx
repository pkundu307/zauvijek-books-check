...
export default function FormSaleOrderView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
      ...
      <Flex p={4} justify="space-between" align="center">
        <Stack direction="row" align="center" spacing={2}>
          ...
          <Breadcrumb separator={<RiArrowRightSLine />}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} to="/sale-order">
                Sale Order
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
        ...
        <GridItem colSpan={1}>
          ...
          >
            <Stack p={4} spacing={6}>
              <Stack direction="row" spacing={4}>
                <FormControl>
                  <FormLabel fontSize="sm">Sale Order Prefix</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_prefix"
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Sale Order No.</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_no"
                    render={({ field: { value, onChange, onBlur } }) => (
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Sale Order Date</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_date"
                    render={({ field: { value, onChange } }) => (
