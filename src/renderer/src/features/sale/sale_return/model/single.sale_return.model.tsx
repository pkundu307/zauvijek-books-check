...
import SingleSaleReturnController from '../controller/single.sale_return.controller'

export default function SingleSaleReturnModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
