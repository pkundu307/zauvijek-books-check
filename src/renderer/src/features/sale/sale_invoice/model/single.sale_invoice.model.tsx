...
import SingleSaleInvoiceController from '../controller/single.sale_invoice.controller'

export default function SingleSaleInvoiceModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
