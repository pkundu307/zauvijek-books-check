...
import SingleSaleInvoiceView from '../view/single.sale_invoice.view'

const SingleSaleInvoiceController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SingleSaleInvoiceController
