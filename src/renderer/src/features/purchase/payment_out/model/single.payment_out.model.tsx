...
import SinglePaymentOutController from '../controller/single.payment_out.controller'

export default function SinglePaymentOutModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
