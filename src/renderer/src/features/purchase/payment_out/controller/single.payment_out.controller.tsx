...
import SinglePaymentOutView from '../view/single.payment_out.view'

const SinglePaymentOutController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SinglePaymentOutController
