...
export default function FormPurchaseOrderView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return (
    <AppLayout>
      <Flex p={4} justify="space-between" align="center">
        <Stack direction="row" align="center" spacing={2}>
          ...
          <Breadcrumb separator={<RiArrowRightSLine />}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} to="/purchase-order">
                Purchase Orders
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
      ...
      >
        ...
        <GridItem colSpan={1}>
          <Container
            title={<Text fontSize="sm">Purchase Order Details</Text>}
            action={
              <Controller
                control={control}
          ...
          >
            <Stack p={4} spacing={6}>
              <Stack direction="row" spacing={4}>
                <FormControl>
                  <FormLabel fontSize="sm">Purchase Order Prefix</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_prefix"
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Purchase Order No.</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_no"
                    render={({ field: { value, onChange, onBlur } }) => (
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Purchase Order Date</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_date"
                    render={({ field: { value, onChange } }) => (
