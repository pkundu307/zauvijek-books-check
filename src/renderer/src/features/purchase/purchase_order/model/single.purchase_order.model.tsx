...
import SinglePurchaseOrderController from '../controller/single.purchase_order.controller'

export default function SinglePurchaseOrderModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
