...
import SinglePurchaseOrderView from '../view/single.purchase_order.view'

const SinglePurchaseOrderController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SinglePurchaseOrderController
