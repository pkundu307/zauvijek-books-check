...
import SinglePurchaseInvoiceController from '../controller/single.purchase_invoice.controller'

export default function SinglePurchaseInvoiceModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return (
    <SinglePurchaseInvoiceController
      id={id}
      activeTab={activeTab}
