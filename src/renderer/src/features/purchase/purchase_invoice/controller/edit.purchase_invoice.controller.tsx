...
import FormPurchaseInvoiceView from '../view/form.purchase_invoice.view'
...
const EditPurchaseInvoiceController = (props: any) => {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
...
export default EditPurchaseInvoiceController
