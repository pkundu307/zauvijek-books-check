...
import ListPurchaseInvoiceView from '../view/list.purchase_invoice.view'

const ListPurchaseInvoiceController = (props: any) => {
  /**
   * ----------------------------------------------------------------------
   *  LOCAL STATES START
   *
...
export default ListPurchaseInvoiceController
