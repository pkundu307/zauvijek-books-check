...
import SinglePurchaseInvoiceView from '../view/single.purchase_invoice.view'

const SinglePurchaseInvoiceController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SinglePurchaseInvoiceController
