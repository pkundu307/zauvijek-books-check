...
export default function FormDebitNoteView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return (
    <AppLayout>
      <Flex p={4} justify="space-between" align="center">
        <Stack direction="row" align="center" spacing={2}>
          ...
          <Breadcrumb separator={<RiArrowRightSLine />}>
            ...
            <BreadcrumbItem>
              <BreadcrumbLink as={Link} to="/debit-note">
                Debit Notes
              </BreadcrumbLink>
            </BreadcrumbItem>
            <BreadcrumbItem>
      ...
      >
        ...
        <GridItem colSpan={1}>
          <Container
            title={<Text fontSize="sm">Debit Note Details</Text>}
            action={
              <Controller
                control={control}
          ...
          >
            <Stack p={4} spacing={6}>
              <Stack direction="row" spacing={4}>
                <FormControl>
                  <FormLabel fontSize="sm">Debit Note Prefix</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_prefix"
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Debit Note No.</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_no"
                    render={({ field: { value, onChange, onBlur } }) => (
                ...
                <FormControl>
                  <FormLabel fontSize="sm">Debit Note Date</FormLabel>
                  <Controller
                    control={control}
                    name="invoice_date"
                    render={({ field: { value, onChange } }) => (
