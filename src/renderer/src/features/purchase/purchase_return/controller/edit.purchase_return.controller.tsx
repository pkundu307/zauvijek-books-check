...
import FormPurchaseReturnView from '../view/form.purchase_return.view'
...
const EditPurchaseReturnController = (props: any) => {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
...
export default EditPurchaseReturnController
