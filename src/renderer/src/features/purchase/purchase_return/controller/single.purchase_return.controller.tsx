...
import SinglePurchaseReturnView from '../view/single.purchase_return.view'

const SinglePurchaseReturnController = (props: any) => {
  const {
    id,
    activeTab,
    setActiveTab,
...
export default SinglePurchaseReturnController
