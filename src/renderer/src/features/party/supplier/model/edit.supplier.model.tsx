...
import EditSupplierController from '../controller/edit.supplier.controller'

export default function EditSupplierModel() {
  /**
   * ----------------------------------------------------------------------
   *  LIBRARY HOOKS START
   *
  ...
  return <EditSupplierController data={data} handleUpdate={handleUpdate} />
}
