...
export default function FormSupplierView(props: any) {
  /**
   * ----------------------------------------------------------------------
   *  CUSTOM HOOKS START
   *
            ...
            <Container title={<Text fontSize="sm">General Details</Text>}>
              <Stack p={4} spacing={6}>
                <Stack direction="row" spacing={4}>
                  <FormControl>
                    <FormLabel fontSize="sm">Supplier Type</FormLabel>
                    <Controller
                      control={control}
                      name="party_form"
                  ...
                  <FormControl>
                    <Flex justify="space-between">
                      ...
                      <ButtonGroup spacing={4}>
                        <Button px={2} h={5} size={'xs'} rounded={0} leftIcon={<RiAddLine />}>
                          Add
                        </Button>
                      </ButtonGroup>
                    </Flex>
                ...
                <Stack spacing={4}>
                  ...
                  <FormControl>
                    <Flex justify="space-between">
                      ...
                      <ButtonGroup spacing={4}>
                        <Button px={2} h={5} size={'xs'} rounded={0} leftIcon={<RiListCheck />}>
                          Select
                        </Button>
                        <Button px={2} h={5} size={'xs'} rounded={0} leftIcon={<RiAddLine />}>
                          Add
