...
export default function SingleCustomerView(props: any) {
            ...
            <Stack p={4} spacing={6}>
              <Stack direction="row" spacing={6}>
                <Stack w="50%">
                  ...
                  <Text fontSize="sm" fontWeight={600}>
                    {parseCurrency(props.data.opening_balance) || '-'}
                  </Text>
                </Stack>
                <Stack w="50%">
                  <Text fontSize="sm" color={mode60}>
              ...
              <Stack direction="row" spacing={6}>
                ...
                <Stack w="50%">
                  ...
                  <Text fontSize="sm" fontWeight={600}>
                    {parseCurrency(props.data.credit_limit) || '-'}
                  </Text>
                </Stack>
              </Stack>
              <Stack direction="row" spacing={6}>
                <Stack w="50%">
                  ...
                  <Text fontSize="sm" fontWeight={600}>
                    {parseCurrency(props.data.closing_balance) || '-'}
                  </Text>
                </Stack>
                <Stack w="50%" />
              </Stack>
